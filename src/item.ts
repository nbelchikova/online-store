...
export const itemsData: IGoods[] = [
      ...
      },
      {
        ...
        brand: 'Beatrees',
        category: 'Искусственные елки',
        description: 'Это елочка по-настоящему волшебна, она в один миг создаст в вашем доме сказочную новогоднюю атмосферу и будет радовать вас и ваших близких, а ее необычный декор в виде натуральных шишек и ярко-красных ягодок добавят празднику задорства и веселья.',
      ...
      },
      {
        ...
        brand: 'Bondibon',
        category: 'Электрогирлянды',
        description: 'Световой занавес необыкновенно наряден, он украсит любое помещение, придав ему радостный праздничный стиль. С помощью светового занавеса можно создавать красивые декоративные световые ширмы, оформлять огнями разнообразные плоскости, декорировать объемные объекты.',
      ...
      },
      {
        ...
        brand: 'Edelman',
        category: 'Электрогирлянды',
        description: 'Цветная гирлянда с режимами свечения - верный способ добавить интерьеру пеструю изюминку. Озорные огоньки, легко меняющие свой характер по щелчку контроллера, непременно повеселят и детей, и взрослых. Украсьте гирляндой окно, изголовье кровати или новогоднюю ель - смотреться будет невероятно празднично.',
      ...
      },
      {
        ...
        brand: 'Breitner',
        category: 'Световой декор',
        description: 'Чудесное интерьерное украшение, рождественская горка-светильник с семью электрическими свечами, станет королевой праздничного декора! Поставьте ее на обеденный стол или комод у стены, и комната в мгновение ока наполнится теплым светом и праздничным настроением. Установите горку на подоконник, и мягкое мерцание огней, отраженное в оконном стекле, многократно усилит ее очарование. На их таинственное сияние роем слетятся рождественские чудеса, удача и счастье!',
      ...
      },
      {
        ...
        brand: 'Bondibon',
        category: 'Карнавальные костюмы',
        description: 'Новогодний костюм Пиратка из серии "Сделай сам" позволит вам почувствовать себя настоящим модельером! Ведь с его помощью вы вместе с ребёнком сможете собрать маскарадный костюм самостоятельно. Это очень интересное и увлекательное занятие как для детей, так и для взрослых. Следуйте инструкции, входящей в комплект, добавьте немного фантазии, чтобы придать индивидуальности - и наряд готов! Этот новогодний костюм для девочки подойдет на любой праздник в садике или школе и для участия в детском спектакле. Великолепное качество и разнообразие используемых материалов - это отличительные особенности российского бренда, которые несомненно придутся вам по душе.',
      ...
      },
      {
        ...
        brand: 'Bondibon',
        category: 'Карнавальные костюмы',
        description: '«Хо-хо-хо!» – разве не это мечтают услышать все детки в новогоднюю ночь? Преподнесите им удовольствие и получите его сами с декоративной шапкой Санта Клауса. У старичка еще была борода? Это не проблема, ведь она уже пришита к головному убору известного волшебника.',
